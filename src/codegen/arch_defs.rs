...
pub const DOM_SAVE_CCSR_SMODE : &'static [&'static str] = &["cepc", "cpmp(0)", "cpmp(1)", "cpmp(2)", "cpmp(3)", "cpmp(4)",
        "cpmp(5)", "cpmp(6)", "cpmp(7)", "cpmp(8)", "cpmp(9)", "cpmp(10)", "cpmp(11)", "cpmp(12)", "cpmp(13)", "cpmp(14)", "cpmp(15)"];
