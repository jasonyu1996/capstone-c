...
pub const DOM_SAVE_CCSR : &'static [&'static str] = &["cepc", "catp", "cdc", "cscratch"];
pub const DOM_SAVE_CCSR_SMODE : &'static [&'static str] = &[];
pub const DOM_SAVE_CSR : &'static [&'static str] = &["mcause", "mtval", "cdcb"]; // "mtinst"];
pub const DOM_SAVE_CSR_SMODE : &'static [&'static str] = &[];
